...
import { outboxEvents, walletSchema } from './wallet-schema.js';
...
/**
 * Wallet outbox repository. Events are written atomically with the wallet
 * change (same transaction); a background publisher drains pending rows to
 * Pub/Sub. Mirrors the Ledger and Transfer outbox implementations.
 */
@Injectable()
